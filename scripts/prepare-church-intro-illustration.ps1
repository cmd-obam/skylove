...
function Test-TransparentPixel {
  ...
  # Editor checkerboard / near-white background
...
Write-Host "Saved transparent illustration ${cropWidth}x${cropHeight} to $outPath"
